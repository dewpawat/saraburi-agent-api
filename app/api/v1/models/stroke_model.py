...
class StrokeIPDItem(BaseModel):
    hospcode: str = Field(..., example="10807")
    cid: str = Field(..., example="1103700999999")
    hn: str = Field(None, example="000123456")
    an: str = Field(..., example="0000123456")
    pname: str = Field(..., example="นาง")
    fname: str = Field(..., example="จันทร์เจ้า")
    lname: str = Field(..., example="ศรีสุข")
...
class StrokeOPDItem(BaseModel):
    hospcode: str = Field(..., example="10807")
    cid: str = Field(..., example="1103700999999")
    hn: str = Field(..., example="000123456")
    vn: str = Field(..., example="650101123456")
    pname: str = Field(..., example="นาย")
    fname: str = Field(..., example="สมพงษ์")
    lname: str = Field(..., example="ศรีสุข")
